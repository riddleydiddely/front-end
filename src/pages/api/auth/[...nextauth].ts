...
export const authOptions = {
  ...
  callbacks: {
    ...
    async signIn({ user }: { user: User }): Promise<boolean> {
      const allowed_emails: string[] = ["donny.ho@getriddle.com", "kyle.rowley@getriddle.com", "dieu.donny.ho@gmail.com", "dhtechnologyconsulting@gmail.com", "hyperformanceads@gmail.com", "adii@longecommerce.com"]
