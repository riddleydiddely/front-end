...
export default function ChatBox(props: ChatBoxProps) {
    ...
    return (
        <div className="fixed bottom-0 right-0 z-50 shadow-xl pr-4 pb-4  ">
            ...
            <div className={`w-80 ${chatOpen ? "h-96" : "h-10"} duration-700 flex flex-col rounded-lg border border-gray-300 shadow-md bg-white`}>
                ...
                <div className={`flex items-center border-t p-2 duration-1000 ${chatOpen ? "" : "hidden"}`}>
                        ...
                        <input type="text" placeholder="Ask co-pilot anything" className="input-md input-bordered w-full max-w-xs" onKeyDown={(input) => handleKeyDown(input)} />
