...
export default function Dashboard() {
  ...
  return (
    <div className="flex bg-white rounded-xl py-5 mt-10 justify-center overflow-y-scroll">
      <div className="grid gap-x-8 gap-y-4
        ...
        {(DashboardData.concat(DashboardData, DashboardData)).map(
          (dashboard, key) =>
            <div key={key} className="py-5 block max-w-sm p-6 bg-white border mt-10 border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
